    ...
    .big-picture-preview{
      ...
      .menu-wrapper{
        ...
        .item{
          ...
          &.left-rotate{
            background: url("./route_left.png") no-repeat center center;
            background-size: 36px auto;
          }
          &.right-rotate{
            background: url("./route_right.png") no-repeat center center;
            background-size: 36px auto;
          }
          &.big{
            background: url("./zoom_up.png") no-repeat center center;
            background-size: 36px auto;
          }
          &.small{
            background: url("./zoom_down.png") no-repeat center center;
            background-size: 36px auto;
          }
          &.disabled{
            opacity: 0.1;

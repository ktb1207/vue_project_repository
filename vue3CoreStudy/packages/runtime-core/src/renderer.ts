...
type PatchFn = (
  n1: VNode | null, // null means this is a mount // 旧节点，如果为空表示mount
  n2: VNode, // 新节点
  container: RendererElement, // container 是新节点的容器
  anchor?: RendererNode | null, // 是一个锚点，用来标识当我们对新旧节点做增删或移动等操作时，以哪个节点为参照物
  parentComponent?: ComponentInternalInstance | null,
  parentSuspense?: SuspenseBoundary | null,
  isSVG?: boolean,
  slotScopeIds?: string[] | null,
  optimized?: boolean // optimized 参数是是否开启优化模式的标识
) => void
